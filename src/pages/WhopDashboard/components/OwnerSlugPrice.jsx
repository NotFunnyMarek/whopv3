            ...
            <div className="price-field">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  whopData.currency = val;
                  setNewSlugValue((prev) => ({ ...prev, currency: val }));
                }}
              />
            </div>
            <div className="price-field">
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  whopData.is_recurring = rec;
                  setNewSlugValue((prev) => ({ ...prev, is_recurring: rec }));
                }}
              >
              ...
              <div className="price-field">
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    whopData.billing_period = period;
                    setNewSlugValue((prev) => ({ ...prev, billing_period: period }));
                  }}
                >
